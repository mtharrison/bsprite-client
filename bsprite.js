...
(function(globals) {
  ...
  /**
   * Returns array buffer data as a base64 encoded string
   *
  ...
  /**
   * Returns array buffer data as a UTF-8 string
   */
